/**
 * Purpose: Handles local email/password and demo provider login for the laptop-only build.
 * Used by: /login route.
 * Main dependencies: localClient auth methods, router links, and auth layout UI.
 * Public functions: Login default export.
 * Side effects: writes session state to localStorage and redirects on success.
 */
...
export default function Login() {
  ...
  const handleGoogle = () => {
    localClient.auth.loginWithProvider("google", "/home");
  };
