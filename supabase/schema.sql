...
create index if not exists villa_owners_email_idx on public.villa_owners (email);
...
create index if not exists website_settings_key_idx on public.website_settings (key);
...
drop policy if exists "Admins read booking inquiries" on public.booking_inquiries;
...
drop policy if exists "Admins read owner inquiries" on public.owner_inquiries;
...
drop policy if exists "Admins read villa assessments" on public.villa_assessments;
...
drop policy if exists "Admins manage villa owners" on public.villa_owners;
